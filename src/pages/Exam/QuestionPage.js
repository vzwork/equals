...
import { View, Text, StyleSheet, Button, Switch, Image, TouchableOpacity, Icon } from "react-native";
    ...
    <View style={styles.container}>
        ...
        <View style={styles.contentContainer}>
          ...
          <View style={styles.viewBox}>
            <Text style={styles.examHeaderText}>Regarding alterations and repairs to existing structures, which of the following statements is correct?</Text>
          </View>
